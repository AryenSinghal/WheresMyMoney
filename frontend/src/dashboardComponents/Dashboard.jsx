          ...
          <div className="col-span-1 lg:col-span-2 row-span-2 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-xl hover:shadow-2xl transition-all duration-300">
            <div className="h-full flex flex-col p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <button 
                  onClick={toggleChart}
                  className="px-4 py-2 bg-purple-500/20 hover:bg-purple-500/30 text-purple-300 font-medium rounded-lg transition-all duration-200 flex items-center gap-2 cursor-pointer"
                >
